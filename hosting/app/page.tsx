  ...
  return (
    <div className="min-h-screen bg-neutral-100 relative">
      ...
      <div className="flex justify-center mt-8">
        <div className="w-full min-h-screen max-w-6xl mx-2">
          {!loggedIn && (
            <Link href="/account">
              <Button
                color="primary"
                variant="solid"
                className="w-full mt-4 font-bold bg-rose-100 border-1 border-rose-400 text-rose-700"
              >
                登録・ログインはこちら
              </Button>
            </Link>
          ...
          {loggedIn && showLastQuestionnaire && (
            <Link href="/account">
              <Button
                color="primary"
                variant="solid"
                className="w-full mt-4 font-bold bg-rose-100 border-1 border-rose-400 text-rose-700"
              >
                AIプログラミング体験、皆さんお疲れ様でした。今後の参考のため、ぜひ振り返りアンケートにご協力ください。
              </Button>
            </Link>
          )}
          {loggedIn && (
            <>
              ...
              <Link href="/documentation/setup">
                <Button
                  color="primary"
                  variant="solid"
                  className="w-full mt-6 h-14 font-bold text-md bg-indigo-100 text-indigo-700 shadow-lg flex flex-col items-center justify-center gap-2"
                >
              ...
              <Link href="/documentation/common-issue">
                <Button
                  color="primary"
                  variant="solid"
                  className="w-full mt-4 h-14 font-bold text-md bg-indigo-100 text-indigo-700 shadow-lg flex flex-col items-center justify-center gap-2"
                >
